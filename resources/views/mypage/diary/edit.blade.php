...
@section('content')
    ...
    @endif
    {!! Form::open(['route' => ['diary.updata',$diary->id], 'method' => 'post', 'id' => $diary->id, 'files' => true]) !!}
        <div class="row">
            ...
            <div class="form-group col-sm-3">
                {!! Form::label('date', '日付') !!}
                {!! Form::text('date',$diary->date, ['class' => 'form-control','placeholder' => 'YYYY-MM-DD']) !!}
            </div>
        ...
        <div class="form-group">
            ...
            {!! Form::textarea('content', $diary->content, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group">
